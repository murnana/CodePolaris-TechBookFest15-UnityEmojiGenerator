#ifndef __TEXT_MESH_PRO__CUSTOM__DISTANCE_ADDITIONAL_RED__INCLUDED__
#define __TEXT_MESH_PRO__CUSTOM__DISTANCE_ADDITIONAL_RED__INCLUDED__
...
pixel_t VertShader(vertex_t input)
{
    ...
    float4 vPosition = UnityObjectToClipPos(
        ShiftMoveTo(_EffectOffset, _EffectRotateZ, input.position)
    );
...
fixed4 PixShader(pixel_t input) : SV_Target
{
    ...
    return fixed4(faceColor.r, 0, 0, faceColor.a) * input.color.a * _EffectAlpha;
}
#endif
